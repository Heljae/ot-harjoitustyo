...
class TestBoard(unittest.TestCase):
    ...
    def test_board_setup_changes_the_unseen_fen(self):
        ...
        self.assertEqual("rnbqkbnr/ppppppqp/11111111/11111111/11111111/11111111/PPPPQPPP/RNBQKBNR", self.board.unseen_fen)
    ...
    def test_board_without_icons_and_dots(self):
        ...
        self.assertEqual("rnbqkbnr/pppppppp/11111111/11111111/11111111/11111111/PPPPPPPP/RNBQKBNR", board)

    def test_new_position_in_list_rook(self):
        board = ['rnbqkbnr', 'pppppppp', '11111111', '11111111', '11111111', '11111111', 'PPPPPPPP', 'RNBQKBNR']
        position = self.board.new_position_in_list("Rh1", "Rh3", board)
        self.assertEqual(['rnbqkbnr', 'pppppppp', '11111111', '11111111', '11111111', '1111111R', 'PPPPPPPP', 'RNBQKBN1'], position)

    def test_new_position_in_list_black_knight(self):
        board = ['rnbqkbnr', 'pppppppp', '11111111', '11111111', '11111111', '11111111', 'PPPPPPPP', 'RNBQKBNR']
        position = self.board.new_position_in_list("Ng8", "nf6", board)
        self.assertEqual(['rnbqkb1r', 'pppppppp', '11111n11', '11111111', '11111111', '11111111', 'PPPPPPPP', 'RNBQKBNR'], position)

    def test_board_list_to_dict(self):
        board = ['rnbqkbnr', 'pppppppp', '11111111', '11111111', '11111111', '11111111', 'PPPPPPPP', 'RNBQKBNR']
        correct_dict = {0:'rnbqkbnr', 1:'pppppppp', 2:'11111111', 3:'11111111', 4:'11111111', 5:'11111111', 6:'PPPPPPPP',7:'RNBQKBNR'}
        dict_board = self.board.board_list_to_dict(board)
        self.assertEqual(correct_dict, dict_board)

    def test_board_dict_to_list(self):
        correct_list = ['rnbqkbnr', 'pppppppp', '11111111', '11111111', '11111111', '11111111', 'PPPPPPPP', 'RNBQKBNR']
        board_dict = {0:'rnbqkbnr', 1:'pppppppp', 2:'11111111', 3:'11111111', 4:'11111111', 5:'11111111', 6:'PPPPPPPP',7:'RNBQKBNR'}
